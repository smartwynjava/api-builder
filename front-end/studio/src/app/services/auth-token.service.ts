...
export class TokenAuthenticationService extends IAuthenticationService {
    ...
    constructor(private http: HttpClient, private config: ConfigService) {
        super();
        this.accessToken = "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJpZCI6InRlc3QifQ.BaGxNQFedbRaRJUZkeRaq3Wo_4elMmmS7FKSqgAB80dy3aveXGhSbOCZUt9JkNsBijZYexxhp5TRw2ffkS1v8A";
    ...
    public injectAuthHeaders(headers: {[header: string]: string}): void {
        let authHeader: string = this.accessToken;
