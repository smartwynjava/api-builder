...
import { GenerateCodeWizardComponent } from "./pages/apis/{apiId}/_components/generate-code.wizard";
...
@NgModule({
    ...
    declarations: [
        ...
        GenerateProjectWizardComponent, GenerateCodeWizardComponent, ActivityItemComponent, EditorDisconnectedDialogComponent, MockPageComponent,
